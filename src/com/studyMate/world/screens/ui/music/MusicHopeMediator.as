package com.studyMate.world.screens.ui.music
{
	 ...
	 * 
	 */	
	public class MusicHopeMediator extends ScreenBaseMediator
	{
		public static const NAME:String = "MusicHopeMediator";
		
		private const HOPE_MUSIC:String= NAME+"HOPE_MUSIC";
		
		
		private var pareVO:SwitchScreenVO;
		private var img:Image;
		private var searchTxt:TextFieldHasKeyboard;
		public function MusicHopeMediator(viewComponent:Object=null)
		{
		...
		override public function onRegister():void{
			...
			img = new Image(Assets.getMusicSeriesTexture("marketHopeAlert"));
		...
		private function showHandler():void{
			...
			var tip:TextField = new TextField(500,40,'小贴士：请许愿音乐商城没有且搜索不到的歌曲','HeiTi',20);
			tip.x = 50;
			tip.y = 180;
			tip.touchable = false;
			view.addChild(tip);
		...
		private function sureBtnHandler(e:TouchEvent):void
		{
			if(e.touches[0].phase==TouchPhase.BEGAN){
				...
				if(infoStr !=""){		
					...
					sendNotification(CoreConst.TOAST,new ToastVO("请输入您想要的歌名"));
				}
			}
		...
		private function sendInfo(infoStr:String):void{
			...
			sendNotification(CoreConst.SEND_11,new SendCommandVO(HOPE_MUSIC));	//派发调用绘本列表参数，调用后台
		}
