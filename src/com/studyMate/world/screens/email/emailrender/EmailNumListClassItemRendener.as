package com.studyMate.world.screens.email.emailrender
{
	...
	public class EmailNumListClassItemRendener extends BaseListItemRenderer
	{
		...
		public function EmailNumListClassItemRendener()
		{
		...
		{
			if(this.data){
/*				texture = Assets.getEmailAtlasTexture("read");
		...
		override protected function initialize():void
		{
			if(!this.creattime)
			{
				...
				texture = Assets.getEmailAtlasTexture("coin");
...
/*				this.sendid = new TextField(100,50,'',"HeiTi",15,0x8E9080,false);
		...
		private function collectHandler():void
		{
			if(!Global.isLoading){
				...
				Facade.getInstance(CoreConst.CORE).sendNotification(CoreConst.SEND_11,new SendCommandVO(COLLECTEMAIL));
			}
		}
