...
package com.studyMate.world.component.sysface
{
	 ...
	 * @private
	 */
	public final class TextFieldViewPortExtends extends FeathersControl implements IViewPort
	{
		private static const HELPER_MATRIX:Matrix = new Matrix();
		private static const HELPER_POINT:Point = new Point();
		
		public function TextFieldViewPortExtends()
		{
			super();
			...
			if(dataInvalid || stylesInvalid)
			{
				...
				else
				{
					...
					if(this._textField.parent){
						while(this._textField.parent.numChildren>1){
							this._textField.parent.removeChildren(1);
						}						
					}
					sysFace.checkFaces(this._textField);					
				}
