...
package com.studyMate.world.component.sysface
{
	 ...
	 */
	public class TextFieldExtends extends DisplayObjectContainer
	{
		...
		public function TextFieldExtends(width:int, height:int, text:String, fontName:String="Verdana",
...
//			else{	
			...
			container.removeChildren();			
			if(ChatFace.checkStr(sNativeTextField.text)){				
				container.addChild(sNativeTextField);				
				ChatFace.addFace(sNativeTextField);
				bitmapData.draw(container, drawMatrix);
			}else{
