package com.mylib.game.fightGame
{
	...
	public class FightingPlaybackMediator extends ScreenBaseMediator
	{
		...
		public function FightingPlaybackMediator(viewComponent:Object=null)
		{
		...
		override public function onRegister():void
		{
			...
			player1.decision =  new HeroGoAI(new Point(400,200),null);
			player1.start();
			...
			player2.decision =  new HeroGoAI(new Point(400,200),null);
			player2.start();*/
		...
		private function keepHandle():void{
			...
			/*player1.charater.view.addChild(eff);
			eff.x = -180;
			eff.y = -100;
