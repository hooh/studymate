...
package myLib.myTextBase.extendsFeather
{
	...
	/**
	 * 复制feather 的stageTextField 
	 */
	public final class StageTextFieldExtends extends EventDispatcher
	{
		/**
		 * Constructor.
		 */
		public function StageTextFieldExtends(initOptions:Object = null)
		{
		...
		{
			this._textField.replaceText(selectionActiveIndex,selectionAnchorIndex,value);
		}
		...
		public function set fontFamily(value:String):void
		{
			...
			if(this._textFormat.font == "HeiTi"){
